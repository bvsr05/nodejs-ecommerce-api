...
export const getOrderStatsCtrl = asyncHandler(async (req, res) => {
  ...
  //res.status(200).json({    success: true,    message: "Sum of orders",    orders,     });
  ...
  //send response
  res.status(200).json({    success: true,    message: "Sum of orders",    orders,    saleToday,   });
